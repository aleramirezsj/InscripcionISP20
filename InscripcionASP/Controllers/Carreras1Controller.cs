...
{
    public class Carreras1Controller : Controller
    {
        private readonly InscripcionASPContext _context;

        public Carreras1Controller(InscripcionASPContext context)
        {
            _context = context;
        }
        ...
        // GET: Carreras1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Carreras1/Create
